...
class Person(object):
    ...
    def displayInfo(self):
        ...
        print('My name is', name, 'and I am doing my', education)


if __name__ == '__main__':
    myObj = Person('Utkarsh')
    myObj.displayInfo()
    print(myObj.name)  # Can be accessed as it is public variable
    # print(myObj.__education)                  # Throws an error
    # print(myObj._Person__education)  # Private variable can be accessed like this but NEVER EVER do this
